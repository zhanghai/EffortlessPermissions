...
[Sample APK](//github.com/DreaminginCodeZH/EffortlessPermissions/releases/download/v1.0.1/sample-release.apk)
...
```gradle
compile 'me.zhanghai.android.effortlesspermissions:library:1.0.1'
```
